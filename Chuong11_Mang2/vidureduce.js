//flat - làm phẳng mảng  từ mảng sâu
//bai 1
...
//dùng map để hiển thị ra Html cho ng dùng xem
...
function calculateRating(watchList) {
    ...
    var timKiem = watchList.filter(function (flim) {
        return flim.Director == "Christopher Nolan";
    });
    var newArray = [];
    newArray = timKiem;
    // console.log(newArray);
    var total = newArray.reduce(function (bienLT, gtHT) {
        gtHT.imdbRating = Number(gtHT.imdbRating);
        return bienLT + gtHT.imdbRating;

    }, 0);
    var soPhim = newArray.length;
    return total / soPhim
}
...
function arrToObj(arr){
    return arr.reduce(function (mang,ht){
         mang[ht[0]]=ht[1];
         return mang;
    },{});
}
